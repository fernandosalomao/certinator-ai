...
description: Review currently architecture
...
The outcome will be used to update the [Architecture Documentation](../../ARCHITECTURE.md) documentation, so please ensure the architecture plan is comprehensive and well-structured. This will be used for implementation, so include technical details, agent roles, interactions, and tool integrations.
...
Demonstrate the **Requirements** below in the architecture design.
